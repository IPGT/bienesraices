<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if(!$imagen['name'] || $imagen['error'] ) {
            $errores[] = 'La imagen debe ser Obligatoria';
        }
            ...
            <fieldset>
                ...
                <select name="vendedor">
                    ...
                    <?php while($vendedores_id = mysqli_fetch_assoc($resultado) ) : ?>
                        <option <?php echo $vendedores_id === $vendedores['id'] ? 'selected' : '';?> value="<?php echo $vendedores_id['id'] ?>"> <?php echo $vendedores_id['nombre'] . " " . $vendedores_id['apellido'] ?> </option>
                    <?php endwhile; ?>    
                </select>
            </fieldset>
